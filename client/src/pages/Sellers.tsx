...
export default function Sellers() {
  const SELLERS_META_DESCRIPTION =
    "West LA sellers face 5.5% in ULA + capital gains — see the full tax stack, timing, and net-proceeds strategy before you list.";

  return (
    <div className="min-h-screen bg-[#111111]">
      <SEO
        title="Sell Your Home in Los Angeles | Seller Strategy + Valuation"
        description={SELLERS_META_DESCRIPTION}
        canonical="https://ryanklosangeles.com/sellers"
        schema={[
          getWebPageSchema(
            "Sell Your Home in Los Angeles",
            SELLERS_META_DESCRIPTION,
